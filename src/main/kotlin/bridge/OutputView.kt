...
class OutputView {
     ...
     */
    fun printMap(firstRowResult: ArrayList<String>, secondRowResult: ArrayList<String>) {
     ...
     * 출력을 위해 필요한 메서드의 인자(parameter)는 자유롭게 추가하거나 변경할 수 있다.
     */
    fun printResult(result: Result, tryCount: Int) {
        println("최종 게임 결과")
        printMap(result.firstRowResult, result.secondRowResult)

...
class Validator {
    ...
    fun checkRestartValueInRAndQ(input : String) {
        require(input.equals(RESTART_VALUE) or input.equals(QUIT_VALUE)) {
            RESTART_VALUE_ERROR_MSG
        }
    }
    ...
    companion object {
        ...
        const val RESTART_VALUE = "R"
        const val QUIT_VALUE = "Q"
        ...
        const val RESTART_VALUE_ERROR_MSG = ERROR_MSG + "  R(재시작)과 Q(종료) 중 하나의 문자를 입력해야 합니다."
    }
}
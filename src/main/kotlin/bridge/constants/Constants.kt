...
const val MAP_PRINT_START = "[ "
const val MAP_PRINT_END = " ]"
const val MAP_PRINT_SEPARATOR = " | "
const val MAP_PRINT_O = "O"
const val MAP_PRINT_X = "X"

const val BRIDGE_LENGTH_START = 3
const val BRIDGE_LENGTH_END = 20

const val SUCCESS = "성공"
const val FAIL = "실패"

const val ERROR_BRIDGE_INPUT = "다리 길이는 3부터 20 사이의 숫자여야 합니다."

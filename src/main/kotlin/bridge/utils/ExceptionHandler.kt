...
object ExceptionHandler {
    ...
    fun validateIntType(input: String){
        try {
            ...
            println(ERROR_NOT_INT_TYPE_MESSAGE)
    ...
    fun validateInRange(inputBridgeSize: Int){
        require(inputBridgeSize in 3..20) { println(ERROR_BRIDGE_SIZE_NOT_IN_3_AND_20_MESSAGE) }
    }
    ...
    fun validateMoveLaneSymbol(inputMoveLaneSymbol: String){
        require(inputMoveLaneSymbol == "U" || inputMoveLaneSymbol == "D") { println(ERROR_NOT_U_OR_D_MESSAGE) }
    }
    ...
    fun validateRetrialSymbol(inputRetrialSymbol: String){
        require(inputRetrialSymbol == "R" || inputRetrialSymbol == "Q") { println(ERROR_NOT_R_OR_Q_MESSAGE) }
    }
}

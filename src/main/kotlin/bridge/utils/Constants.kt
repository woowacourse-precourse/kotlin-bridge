...
object Constants {
    ...
    const val GAME_INPUT_MOVE_LANE_MESSAGE = "이동할 칸을 선택해주세요. (위: U, 아래: D)"
    const val GAME_INPUT_RETRIAL_MESSAGE = "게임을 다시 시도할지 여부를 입력해주세요. (재시도: R, 종료: Q)"
    const val GAME_FINISH_MESSAGE = "최종 게임 결과"
    const val GAME_SUCCESS_OR_FAIL_MESSAGE = "게임 성공 여부: "
